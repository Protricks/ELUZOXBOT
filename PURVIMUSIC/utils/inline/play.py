...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
      ...
      [
            InlineKeyboardButton(
                text="𝖮ᴡɴᴇʀ 🥀", url="https://t.me/INTERVAL_DON",
            ),
            InlineKeyboardButton(
                text="𝖲ᴜᴘᴘᴏʀᴛ 🥀", url="https://t.me/DON_ABOUTT",
            )
        ],
...
def stream_markup(_, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="𝖮𝗐𝗇𝖾𝗋🥀", url="https://t.me/INTERVAL_DON",
            ),
            InlineKeyboardButton(
                text="𝖲𝗎𝗉𝗉𝗈𝗋𝗍🥀", url="https://t.me/DON_ABOUTT",
            )
        ],
        [InlineKeyboardButton(text=_["CLOSE_BUTTON"], callback_data="close")],
    ]
